...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void initState() {
    super.initState();
    Timer(const Duration(milliseconds: 2000), _goToHome);
  }
  ...
  void _goToHome() {
    ...
    Navigator.of(context).pushReplacement(
      PageRouteBuilder(
        ...
        pageBuilder: (_, animation, secondaryAnimation) => const MainNavShell(),
          ...
          children: [
            Stack(
              ...
              children: [
                ...
                _SplashWordmark()
                    .animate()
                    .fadeIn(delay: 150.ms, duration: 850.ms, curve: Curves.easeOut)
                    .slideY(
                      begin: 0.06,
                      end: 0,
                      delay: 150.ms,
...
class _SplashOrnament extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      mainAxisSize: MainAxisSize.min,
      children: [
        Container(width: 26, height: 1, color: AuryelColors.gold.withValues(alpha: 0.45)),
        Padding(
