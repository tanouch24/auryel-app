...
RewardsController _rewards(http.Response Function() response) =>
    RewardsController(
      api: RewardsApi(
        ApiClient(
...
Widget _host(RewardsController rewards) => RewardsScope(
  controller: rewards,
...
void main() {
  testWidgets('pilule consultation gratuite affiche les droits serveur', (
    t,
  ) async {
    final c = _rewards(
      () => http.Response(
    ...
    expect(find.text('3 questions gratuites'), findsOneWidget);
  });
